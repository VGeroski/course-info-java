...
public class CourseRetrievalService {
    ...
    private static final HttpClient CLIENT = HttpClient
            .newBuilder()
            .followRedirects(HttpClient.Redirect.ALWAYS) // always redirect if url changed in future
            .build();
    ...
    public List<PluralsightCourse> getCourseFor(String authorId) {
        ...
        try {
            ...
            // instead of returning body immediately, we want to check HTTP response code - because call maybe failed
